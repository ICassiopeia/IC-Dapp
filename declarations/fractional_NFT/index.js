...
import { idlFactory } from './fractional_NFT.did.js';
export { idlFactory } from './fractional_NFT.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FRACTIONAL_NFT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./fractional_NFT.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the fractional_NFT canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./fractional_NFT.did.js")._SERVICE>}
 */
export const fractional_NFT = createActor(canisterId);
