...
import { idlFactory } from './sales_contract.did.js';
export { idlFactory } from './sales_contract.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SALES_CONTRACT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./sales_contract.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the sales_contract canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./sales_contract.did.js")._SERVICE>}
 */
export const sales_contract = createActor(canisterId);
