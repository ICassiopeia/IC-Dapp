...
import { idlFactory } from './dapp_frontend.did.js';
export { idlFactory } from './dapp_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DAPP_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dapp_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dapp_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dapp_frontend.did.js")._SERVICE>}
 */
export const dapp_frontend = createActor(canisterId);
