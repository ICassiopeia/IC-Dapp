...
import { idlFactory } from './dapp_backend.did.js';
export { idlFactory } from './dapp_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DAPP_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dapp_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dapp_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dapp_backend.did.js")._SERVICE>}
 */
